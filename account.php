...
<head>
  ...
  <script type="text/javascript" src="<?php $_SERVER ['DOCUMENT_ROOT']?>/js/common.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="<?php $_SERVER ['DOCUMENT_ROOT']?>/css/custom.css"/>
	<link rel="stylesheet" type="text/css" href="<?php $_SERVER ['DOCUMENT_ROOT']?>/css/account.css"/>
...
function login(){
  ...
  if(userid!=''&&password!=''){
    ajax = $.ajax({
      url:rootpath+"/controller/signin_controller.php",
      async:false,
      type: 'post',
