...
layui.use('table', function(){
  ...
  $('body').on('click','#edit',function(){
    ...
    layer.open({  //打开组选择弹出层
      ...
      shade: 0.4,
      area: ['380px','378px'],
      content: rootpath+'/view/manage/userManageEditIframe.php?userid='+userid+'&username='+username+'&usertype='+usertype+'&email='+email+'&zu='+zu+'&zuid='+zuid,
      end:function(){
        if(tableRef==true){
          initTable('');
          tableRef = false;
  ...
  $('#add').click(function(){
    layer.open({  //打开组选择弹出层
      ...
      shade: 0.4,
      area: ['380px','378px'],
      content: rootpath+'/view/manage/userManageIframe.php',
      end:function(){
        if(tableRef==true){
          initTable('');
          tableRef = false;
