...
<link rel="stylesheet" type="text/css" href="<?php $_SERVER ['DOCUMENT_ROOT']?>/view/manage/userManageEditIframe.css"/>
...
$('#save').click(function(){
  ...
  if(userid!=''&&password!=''&&username!=''){
    action = 'edit';
    ajax = $.ajax({
      url:rootpath+"/controller/userManage_controller.php",
      async:true,
      type: 'post',
...
$('input[name="group"]').click(function(){
  ...
  parent.layer.open({
    ...
    shade: 0.4,
    area: ['540px','540px'],
    content: rootpath+'/view/manage/userManagezuIframe.php',
    end:function(){
