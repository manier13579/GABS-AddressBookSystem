...
<link rel="stylesheet" type="text/css" href="<?php $_SERVER ['DOCUMENT_ROOT']?>/view/manage/zuManageIframe.css"/>
...
$('#add').click(function(){
  ...
  action = 'add';
  ajax = $.ajax({
    url:rootpath+"/controller/zuManage_controller.php",
    async:true,
    type: 'post',
    data: {action,zuid,parentid,zuname},
    beforeSend:function(){
      loadingDiv('load');
    },
    success:function(res){
