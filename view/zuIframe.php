...
<link rel="stylesheet" type="text/css" href="<?php $_SERVER ['DOCUMENT_ROOT']?>/view/zuIframe.css"/>

<div class="wrap">
  <div class="zu-wrap"></div>
  <div class="layui-btn-group">
    <div class="layui-btn layui-btn-warm" id="privately"><span lang="私有"></span></div>
...
layui.use('form', function(){
  ...
  function readZu(){
    action = 'read';
    ajax = $.ajax({
      url:rootpath+"/controller/zu_controller.php",
      async:true,
      type: 'post',
      data: {action},
      beforeSend:function(){
